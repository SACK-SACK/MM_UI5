		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM] 배치별 재고 실사",
									"targetURL": "#syncc16zcamm221-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc16zcamm221-display": {
								"semanticObject": "syncc16zcamm221",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c16.zcamm221",
									"url": sap.ui.require.toUrl("sync/c16/zcamm221")
								}
							}
						}
					}

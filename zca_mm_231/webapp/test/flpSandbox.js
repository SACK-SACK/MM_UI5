		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM] 입출고 폐기 비교",
									"targetURL": "#syncc16zcamm231-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc16zcamm231-display": {
								"semanticObject": "syncc16zcamm231",
								"action": "display",
								"description": "[MM] 입출고 폐기 비교",
								"title": "[MM] 입출고 폐기 비교",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c16.zcamm231",
									"url": sap.ui.require.toUrl("sync/c16/zcamm231")
								}
							}
						}
					}

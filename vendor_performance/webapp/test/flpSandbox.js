		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "밴더 실적",
									"targetURL": "#synccammvendorperformance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccammvendorperformance-display": {
								"semanticObject": "synccammvendorperformance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.mm.vendorperformance",
									"url": sap.ui.require.toUrl("sync/ca/mm/vendorperformance")
								}
							}
						}
					}

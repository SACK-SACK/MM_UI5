		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM]캘린더",
									"targetURL": "#synccammupdatecalendar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccammupdatecalendar-display": {
								"semanticObject": "synccammupdatecalendar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.mm.update.calendar",
									"url": sap.ui.require.toUrl("sync/ca/mm/update/calendar")
								}
							}
						}
					}
